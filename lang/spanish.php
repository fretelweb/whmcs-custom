...
$_LANG['invoiceaddcreditdesc2'] = "Esto puede ser aplicado al recibo utilizando el formulario a continuación.";
...
$_LANG['invoicesdatecreated'] = "Fecha del Recibo";
...
$_LANG['invoicesinvoicenotes'] = "Notas del Recibo";
$_LANG['invoicesnoinvoices'] = "No hay Reciboss";
$_LANG['invoicesnotes'] = "Notas";
$_LANG['invoicesoutstandinginvoices'] = "Recibos Pendientes";
...
$_LANG['ordercompletebutnotpaid'] = "Atención! Su Pedido ha sido completado correctamente. Para activar los Productos/Servicios debe realizar el pago correspondiente.<br />Click en este enlace para ir a su recibo y realizar el pago.";
...
$_LANG['proformainvoicenumber'] = "Recibo Proforma nº";
...
$_LANG['creditcardnostore'] = "Marque esta casilla si NO quiere que se guarden los datos de su tarjeta de crédito para cuando se vuelva a emitir el recibo";
...
$_LANG['upgradeerroroverdueinvoice'] = "Actualmente no puede actualizar ni desactualizar este producto porque se ha generado ya un recibo para la próxima renovación.<br /><br /> Para proceder a hacerlo, por favor en primer lugar pague el recibo pendiente y entonces podrá actualizar y desactualizar inmediatamente después y la diferencia será abonada o cargada según corresponda.";
...
$_LANG['subaccountpermsinvoices'] = "Ver & Pagar recibos";
...
$_LANG['invoicepaymentpendingreview'] = "Gracias! Su pago se ha realizado correctamente y se aplicará a su recibo tan pronto como la revisión del proceso de 2CheckOut se haya completado.<br /><br />Esto puede tomar hasta un par de horas por lo que su paciencia es apreciada.";
...
$_LANG['domainautorenewinfo'] = "La autorenovación ayuda a proteger tu dominio. Cuando está habilitada, te enviaremos automáticamente un recibo de renovación unas semanas antes de que tu dominio expire, y tu dominio será renovado en cuanto realices el pago.";
...
$_LANG['invoicesintro'] = "Su historial de recibos con nosotros.";
...
$_LANG['masspayintro'] = "Pagar todos los recibos en una única y sencilla transacción";
...
$_LANG['youhaveoverdueinvoices'] = "Tiene %s Recibo(s) Vencido(s)";
$_LANG['overdueinvoicesdesc'] = "Para prevenir la interrupción del servicio, por favor, paga tus recibos vencidas lo antes posible. %sPagar Ahora &raquo;%s";
$_LANG['supportticketsnoneopen'] = "Actualmente no hay ningún Ticket de Soporte abierto";
$_LANG['invoicesnoneunpaid'] = "Actualmente no hay recibos sin pagar";
...
$_LANG['domainrenewexp'] = "Activa la autorenovación para que te enviemos un recibo de renovación automáticamente antes de que tu dominio expire.";
...
$_LANG['invoicesdue'] = "Recibo Vencida";
$_LANG['invoicesduemsg'] = "Usted tiene %s recibo(s) vencido(s) por el monto total de %s";
$_LANG['noinvoicesduemsg'] = "No tiene recibos pendientes de pago en este momento.";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Usted tiene :numberOfInvoices recibo(s) impago(s). Pague ahora para evitar su preocupación.";
$_LANG['clientAlerts']['invoicesOverdue'] = "Usted tiene :numberOfInvoices recibos(s) vencido(s) por el monto total de :balanceDue. Pague ahora para evitar interrupciones de servicio.";
$_LANG['clientAlerts']['creditBalance'] = "Usted tiene un saldo acreedor de :creditBalance.";

// Client homepage panels
$_LANG['clientHomePanels']['unpaidInvoices'] = "Recibos Pendientes";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Usted tiene :numberOfInvoices recibo(s) impago(s) por un monto total de :balanceDue. Pague ahora para evitar su preocupación.";
$_LANG['clientHomePanels']['overdueInvoices'] = "Recibos Vencidas";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Usted tiene :numberOfInvoices recibo(s) vencido(s) por el monto total de :balanceDue. Pague ahora para evitar interrupciones de servicio.";
...
$_LANG['store']['sitelock']['cartShortDescription'] = "SiteLock proporciona una gama de características diseñadas para proteger tanto tu sitio web como la reputación de tu empresa.";
...
$_LANG['navMarketConnectService']['codeguard'] = "CodeGuard Website Backup";
...
$_LANG['sslState']['sslRequired'] = "No SSL Detected. Click here to browse SSL options";
...
$_LANG['sslState']['sslInvalidDomain'] = "Not applicable";
